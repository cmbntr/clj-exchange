 ...
 *       &lt;attribute name="Version" use="required" type="{http://schemas.microsoft.com/exchange/services/2006/types}ExchangeVersionType" fixed="Exchange2010_SP1" />
...
public class RequestServerVersion {
    ...
    public ExchangeVersionType getVersion() {
        if (version == null) {
            return ExchangeVersionType.EXCHANGE_2010_SP_1;
        } else {
            return version;
        }
    }
